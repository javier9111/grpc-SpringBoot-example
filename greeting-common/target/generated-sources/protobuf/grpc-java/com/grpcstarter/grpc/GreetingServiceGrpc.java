...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.grpcstarter.greeting.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.grpcstarter.grpc.GreetingRequest,
      com.grpcstarter.grpc.GreetingResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.grpcstarter.grpc.GreetingRequest.class,
      responseType = com.grpcstarter.grpc.GreetingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpcstarter.grpc.GreetingRequest,
      com.grpcstarter.grpc.GreetingResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.grpcstarter.grpc.GreetingRequest, com.grpcstarter.grpc.GreetingResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.grpcstarter.grpc.GreetingRequest, com.grpcstarter.grpc.GreetingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpcstarter.grpc.GreetingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpcstarter.grpc.GreetingResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.grpcstarter.grpc.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.grpcstarter.grpc.GreetingResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.grpcstarter.grpc.GreetingRequest,
                com.grpcstarter.grpc.GreetingResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.grpcstarter.grpc.GreetingResponse greeting(com.grpcstarter.grpc.GreetingRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpcstarter.grpc.GreetingResponse> greeting(
        com.grpcstarter.grpc.GreetingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.grpcstarter.grpc.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.grpcstarter.grpc.GreetingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpcstarter.grpc.Greeting.getDescriptor();
    }
